...
class DNJ:
    ...
    def optimize_route(self, route: RouteRK, num_iter: int = 10):
...
class DNJRandomGuess:
    def __init__(
        ...
        x_start, y_start = q0
        x_end, y_end = q1
        list_routes: List[RouteRK] = [None] * num_routes
        ...
        for idx_route in range(num_routes):
            ...
            list_routes[idx_route] = RouteRK(x, y)
        # Store parameters
        self.dnj = DNJ(
    ...
    def __next__(self) -> List[RouteRK]:
